...
class ConfigHandler(Generic[Target]):
    ...
    """Options aliases.
    For compatibility with various libraries. E.g.: d2to1 and pbr.
...
class ConfigMetadataHandler(ConfigHandler["DistributionMetadata"]):
    ...
    `pbr` and `d2to1` libraries which also uses `metadata` section.
...
class ConfigOptionsHandler(ConfigHandler["Distribution"]):
    ...
    def parsers(self):
        ...
        return {
            ...
            'libraries': self._parse_packages,
    ...
    def _parse_packages(self, value):
        ...
        find_kwargs = self.parse_section_packages__find(
            self.sections.get('libraries.find', {})
        )
    ...
    def parse_section_packages__find(self, section_options):
        """Parses `libraries.find` configuration file section.
