...
WINDOWS_SCHEME = {
    'purelib': '{base}/Lib/site-libraries',
    'platlib': '{base}/Lib/site-libraries',
...
INSTALL_SCHEMES = {
    'posix_prefix': {
        'purelib': '{base}/lib/{implementation_lower}{py_version_short}/site-libraries',
        'platlib': '{platbase}/{platlibdir}/{implementation_lower}'
        '{py_version_short}/site-libraries',
    ...
    'nt': WINDOWS_SCHEME,
    'pypy': {
        'purelib': '{base}/site-libraries',
        'platlib': '{base}/site-libraries',
        'headers': '{base}/include/{dist_name}',
        'scripts': '{base}/bin',
        'data': '{base}',
    },
