...
"""
    ...
    display_options = [
        ...
        ('provides', None, "print the list of libraries/modules provided"),
        ('requires', None, "print the list of libraries/modules required"),
        ('obsoletes', None, "print the list of libraries/modules made obsolete"),
    ]
    ...
    def __init__(self, attrs=None):  # noqa: C901
        ...
        # 'command_packages' is a list of libraries in which commands
        # are searched for.  The factory for command 'foo' is expected
        # to be named 'foo' in the module 'foo' in one of the libraries
    ...
    def _get_toplevel_options(self):
        ...
        return self.global_options + [
            (
                "command-libraries=",
                None,
                "list of libraries that provide distutils commands",
            ),
        ]
    ...
    def get_command_packages(self):
        """Return a list of libraries from which commands are loaded."""
